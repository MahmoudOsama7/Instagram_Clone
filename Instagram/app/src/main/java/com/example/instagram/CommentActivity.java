...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // it means that after doing the needed by the toolbar it will be finished so closed and get back to previous situation
    ...
    {
        FirebaseDatabase.getInstance().getReference("Writing").child(fUser.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
